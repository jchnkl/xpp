...
this fails, check the [`XCBGEN`](src/proto/Makefile#L38) and
[`PROTODIR`](src/proto/Makefile#L39) variables in
...
[src/xpp.hpp](src/xpp.hpp). If an extensions is required, it needs to be
...
implementation of the [core connection methods](src/core.hpp), the core
